...
def get_param_grid_medium() -> Dict[str, Any]:
    """
    Grid MÉDIO - busca mais abrangente.
...
def evaluate_rf_pre_post(
    ...
    search_method:
        - "quick": Grid pequeno, ~54 combinações (~15-30 min)
        - "medium": Grid médio, ~162 combinações (~1-2 horas)
...
if __name__ == "__main__":
    ...
    # OPÇÃO 3 - MÉDIO: 1-2 horas
    # SEARCH_METHOD = "medium"
    
    # OPÇÃO 4 - COMPLETO (CUIDADO!): Muitas horas, pode travar
    # SEARCH_METHOD = "full"
    # ============================================================================
